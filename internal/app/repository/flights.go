...
func (r *Repository) Update_flight_date(app uint, ship uint, date time.Time) (*ds.Flights, error) {
...
func (r *Repository) Update_cosmodrom_begin(app uint, ship uint, cosm uint) (*ds.Flights, error) {
	var flight ds.Flights
